...
pub struct RawReaderSmallAlignedLittleEndian;

impl RawReaderSmallAlignedLittleEndian {
    pub fn read<'a>(reader: &'a SPBFReader, file_type: SPBFType, file_version: SPBFVersion) -> Result<SPBFReadResult<'a>, SPBFReaderError> {
        ...
        let build_name_len = u16::from_le_bytes(build_name_len) as usize;
        ...
        let build_version_len = u16::from_le_bytes(build_version_len) as usize;
