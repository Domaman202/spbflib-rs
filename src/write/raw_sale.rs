...
impl RawWriterSmallAlignedLittleEndian {
    pub fn write(writer: &mut SPBFWriter) -> Result<Vec<u8>, SPBFWriterError> {
        ...
        out.write(&u16::to_le_bytes(usize_to_u16(writer.build_name.len(), SPBFWriterWriteError::InvalidNameLength.into())?))?;
        out.write(&u16::to_le_bytes(usize_to_u16(writer.build_version.len(), SPBFWriterWriteError::InvalidVersionLength.into())?))?;
